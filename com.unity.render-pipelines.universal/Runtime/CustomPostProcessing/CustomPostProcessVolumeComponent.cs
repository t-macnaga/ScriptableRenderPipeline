...
namespace UnityEngine.Rendering.Universal
{
    ...
    public abstract class CustomPostProcessVolumeComponent : VolumeComponent , IPostProcessComponent
    {
        ...
        // public abstract void Render(ScriptableRenderContext context, ref RenderingData renderingData,in RenderTargetHandle source,in RenderTargetHandle dest);
        public abstract void Render(ScriptableRenderContext context, CommandBuffer cmd, ref RenderingData renderingData,int source,int dest);
